...
if __name__ == "__main__":
    ...
    batch_size = 16
    test_dir = "hw2/test_tensors_superres"
    model_dir = "model" 
    output_base_dir = "outputs_super" 
    ...
    print(f"{len(model_files)} models are found in {model_dir}")
    ...
    print(f"\nAll predictions are done, save as{output_base_dir}")
